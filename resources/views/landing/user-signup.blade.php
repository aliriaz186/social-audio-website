                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="form-group">
                            <div class="input-with-icon">
                                <div class="d-flex">
                                    <div>
                                        <select name="countryCode" class="form-control" id="" style="width: 100px;background: white;color: black">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" placeholder="300 546 5847" name="phone">
                                    </div>
                                </div>
