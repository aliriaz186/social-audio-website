...
@section('content')
    ...
    <div class="login-main-left">
        ...
        <h5 class="modal-header-title" style="margin-bottom: 10px">Forgot Password</h5>
        @if($errors->any())
        ...
        <form method="post" action="{{url('forgotpassword')}}">
            ...
            <div class="mt-4">
                <div class="row">
                    <div class="col-12">
                        <button type="submit" class="btn btn-outline-success btn-block btn-lg">SEND PASSWORD RESET LINK
                        </button>
                    </div>
                </div>
            </div>
