...
{{--            <img style="width: 100px; height: 70px; color: white" src="{{asset('landing-page-styles/images/logo.png')}}">--}}
{{--        </a>--}}
...
<nav class="navbar navbar-expand-lg navbar-light bg-white">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="form-inline my-2 my-lg-0">
            <a class="btn btn-outline-success my-2 my-sm-0" type="submit" href="{{url('/login')}}">Login</a>
            <a class="btn btn-outline-success my-2 my-sm-0 ml-2" type="submit" href="{{url('/register')}}">Signup</a>
        </form>
    </div>
</nav>
